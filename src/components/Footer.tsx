        ...
        <footer className="bg-white dark:bg-black border-t border-gray-200 dark:border-gray-800">
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    <div className="text-4xl font-bold mb-6 md:mb-0 flex justify-center md:justify-start md:mt-[5px]">
                    Con<span className="text-[#178E79]">tent Sphere</span>
                    </div>
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            <h2 className="mb-6 text-sm font-semibold  uppercase text-[#178E79]">Resources</h2>
                        ...
                        <div>
                            <h2 className="mb-6 text-sm font-semibold text-[#178E79] uppercase ">Follow us</h2>
                            <ul className="text-gray-500 dark:text-gray-400 font-medium">
                                <li className="mb-4">
                        ...
                        <div>
                            <h2 className="mb-6 text-sm font-semibold  uppercase text-[#178E79]">Legal</h2>
                            <ul className="text-gray-500 dark:text-gray-400 font-medium">
                                <li className="mb-4">
