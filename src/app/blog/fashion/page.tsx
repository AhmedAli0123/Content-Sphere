...
async function Fashionpage() {
  ...
  const query = groq`
    *[_type == "post" && "Fashion" in categories[]->title] {
      _id,
      title,
      slug,
      mainImage {
  ...
  if (fashionPosts.length === 0) {
    return (
      <div className="text-center mt-10">
        <h2 className="text-2xl font-bold">No Fashion Blogs Found</h2>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-6xl mx-auto p-6">
      <h1 className="text-3xl font-bold text-center mb-8">Fash<span className="text-[#178E79]">ion Blogs</span></h1>
